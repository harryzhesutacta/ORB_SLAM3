...
namespace ORB_SLAM3
{
    ...
    std::pair<Sophus::SE3f, bool> System::TrackStereo(const cv::Mat &imLeft, const cv::Mat &imRight, const double &timestamp, const vector<IMU::Point> &vImuMeas, string filename)
    {
        ...
        bool has_tracking = (mTrackingState == 2);
